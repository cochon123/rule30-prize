...
Odd-n unpaired extra at j=2n-5U-134217728 with j>=2 has count
J_k-22369621(-1)^k+22369622 for k>=28. The first cell is n=5U/2+67108865, j=2
for k>=26. Dies at k=27 for that formula (got 44739242, not 89478486). Dies
at k=26 for that formula (got 11184810, not 22369622). Dies at k=26 for
equals odd_s134217728 and odd_s33554432 and clip_gp (got 11184810, not
22369622/22369621). Dies at k=25 for covering. Do not kill equals
odd_s134217728 or odd_s16777216 or odd_s4194304 or odd_s1048576 or
odd_s262144 or odd_s65536 or odd_s16384 or odd_s4096 or odd_s1024 or
odd_s256 or odd_s64 or odd_s16 or odd_s4 at k=27 (all 44739242). Do not
kill pal_kind unpaired at n=5U/2+67108865, j=2 for k>=26. Do not PREFIX
...
Run: python3 research/cycle_zq.py --certify
Dump: research/cycle_zq.json
"""
...
ZP_JSON = Path(__file__).resolve().parent / "cycle_zp.json"
...
def ph67108865_n(k: int) -> int:
    """Covering n=5U/2+67108865, first odd partner-5U+134217728 cell."""
    return parent_half(k) + 67108865


def want_odd_s134217728(k: int) -> int:
    """Odd-n unpaired extra at partner 5U+134217728, j>=2: 0 at k<=25, 11184810 at k=26, 44739242 at k=27."""
    if k <= 25:
        return 0
    if k == 26:
        return 11184810
    if k == 27:
        return 44739242
    return jacobsthal(k) - 22369621 * ((-1) ** k) + 22369622


def odd_s134217728_split(k: int) -> dict:
    """Odd-n unpaired extra at j=2n-5U-134217728 with j>=2. Do not call from tot_form."""
    u = 1 << k
    clip = 5 * u
    n_at = n_bad = 0
    first = None
...
def tot_form() -> dict:
    """k<=64: odd slice J_k-22369621(-1)^k+22369622 for k>=28; dies at k=27 for that form.

    Do not call odd_s134217728_split here.
    Census is odd_s134217728_fold for k<=8.
    """
    n_ok = 0
    if want_odd_s134217728(0) != 0 or want_odd_s134217728(25) != 0:
        return {"ok": False, "k025": True}
    if want_odd_s134217728(26) != 11184810 or want_odd_s134217728(27) != 44739242:
        return {"ok": False, "k2627": True}
    if want_odd_s134217728(28) != 89478486 or want_odd_s134217728(29) != 223696214:
        return {"ok": False, "k2829": True}
    if want_odd_s134217728(26) == want_odd_s134217728(27):
        return {"ok": False, "eq2627": True}
    ...
    for k in range(0, K_ALG + 1):
        ...
        if k <= 25 and want_odd_s134217728(k) != 0:
            return {"ok": False, "z": True, "k": k}
        if k == 26:
            if want_odd_s134217728(k) != 11184810:
                return {"ok": False, "k26": True}
            if want_odd_s134217728(k) == jacobsthal(k) - 22369621 * ((-1) ** k) + 22369622:
                return {"ok": False, "k26f": True}
        if k == 27:
            if want_odd_s134217728(k) != 44739242:
                return {"ok": False, "k27": True}
            if want_odd_s134217728(k) == jacobsthal(k) - 22369621 * ((-1) ** k) + 22369622:
                return {"ok": False, "k27f": True}
        if k >= 28 and want_odd_s134217728(k) != jacobsthal(k) - 22369621 * ((-1) ** k) + 22369622:
    ...
    ok = (
        n_ok == K_ALG + 1
        and want_odd_s134217728(26) != jacobsthal(26) - 22369621 * ((-1) ** 26) + 22369622
        and want_odd_s134217728(27) != jacobsthal(27) - 22369621 * ((-1) ** 27) + 22369622
        and want_odd_s134217728(8) != want_odd_s512(8)
        and want_odd_s134217728(8) != want_odd_s256(8)
        and want_odd_s134217728(8) != want_clip_gp(8)
        and want_odd_s134217728(8) != jacobsthal(8)
        and want_odd_s134217728(8) != want_even_s512(8)
        and want_odd_s134217728(8) == want_odd_s67108864(8)
        and want_odd_s134217728(8) == want_odd_s33554432(8)
        and want_odd_s134217728(8) == want_odd_s16777216(8)
        and want_odd_s134217728(8) == want_even_s67108864(8)
        and want_odd_s134217728(8) == want_even_s33554432(8)
        and want_odd_s134217728(8) == want_even_s16777216(8)
        and want_odd_s134217728(24) == want_odd_s67108864(24)
        and want_odd_s134217728(25) != want_odd_s67108864(25)
        and want_odd_s134217728(25) != want_odd_s33554432(25)
        and want_odd_s134217728(25) != want_odd_s16777216(25)
        and want_odd_s134217728(25) != want_clip_gp(25)
        and want_odd_s134217728(26) != want_odd_s67108864(26)
        and want_odd_s134217728(26) != want_odd_s33554432(26)
        and want_odd_s134217728(26) != want_odd_s4(26)
        and want_odd_s134217728(26) != want_clip_gp(26)
        and want_odd_s134217728(26) == want_clip_gp(25)
        and want_odd_s134217728(26) == want_odd_s33554432(25)
        and want_odd_s134217728(26) == want_odd_s16777216(25)
        and want_odd_s134217728(27) == want_odd_s67108864(27)
        and want_odd_s134217728(27) == want_odd_s16777216(27)
        and want_odd_s134217728(27) == want_odd_s4194304(27)
        and want_odd_s134217728(27) == want_odd_s1048576(27)
        and want_odd_s134217728(27) == want_odd_s262144(27)
        and want_odd_s134217728(27) == want_odd_s65536(27)
        and want_odd_s134217728(27) == want_odd_s16384(27)
        and want_odd_s134217728(27) == want_odd_s4096(27)
        and want_odd_s134217728(27) == want_odd_s1024(27)
        and want_odd_s134217728(27) == want_odd_s256(27)
        and want_odd_s134217728(27) == want_odd_s64(27)
        and want_odd_s134217728(27) == want_odd_s16(27)
        and want_odd_s134217728(27) == want_odd_s4(27)
        and want_odd_s134217728(27) == want_even_s67108864(27)
        and want_odd_s134217728(27) == want_clip_gp(27)
        and want_odd_s134217728(27) != want_odd_s33554432(27)
        and want_odd_s134217728(27) != want_odd_s8388608(27)
        and want_odd_s134217728(8) == 0
        and want_odd_s134217728(25) == 0
        and want_odd_s134217728(26) == 11184810
        and want_odd_s134217728(27) == 44739242
        and want_odd_s134217728(28) == 89478486
        and jacobsthal(26) - 22369621 * ((-1) ** 26) + 22369622 == 22369622
        and jacobsthal(27) - 22369621 * ((-1) ** 27) + 22369622 == 89478486
        and jacobsthal(28) - 22369621 * ((-1) ** 28) + 22369622 == 89478486
        ...
        and ph67108865_n(25) == 150994945
        and ph67108865_n(26) == 234881025
        and ph67108865_n(27) == 402653185
        ...
        and pal_kind(ph67108865_n(24), 2, 24) == "unp"
        and pal_kind(ph67108865_n(26), 2, 26) == "unp"
        and pal_kind(ph67108865_n(26), 2, 26) == "unp"
        and pal_kind(ph67108865_n(26), 2, 26) != "pair"
        and G(ph67108865_n(25), 2) == 1
        and G(ph67108865_n(26), 2) == 1
        and ph67108865_n(25) >= 4 * (1 << 25)
...
def odd_s134217728_fold() -> dict:
    """k<=8 odd partner-5U+134217728 slice vs J_k-22369621(-1)^k+22369622 for k>=28."""
    n_ok = 0
    rows = {}
    for k in range(0, K_COUNT + 1):
        a = odd_s134217728_split(k)
        if a["n_bad"] != 0:
            return {"ok": False, "bad": True, "k": k, "got": a}
        if a["n_at"] != want_odd_s134217728(k):
            return {"ok": False, "at": True, "k": k, "got": a["n_at"]}
        if k >= 26:
            if a["first"] != (ph67108865_n(k), 2):
...
def killed_eq() -> dict:
    """formula at k=26 and k=27; equals odd_s67108864 at k=26; covering at k=25."""
    ok = (
        want_odd_s134217728(26) != jacobsthal(26) - 22369621 * ((-1) ** 26) + 22369622
        and want_odd_s134217728(27) != jacobsthal(27) - 22369621 * ((-1) ** 27) + 22369622
        and want_odd_s134217728(8) != want_odd_s512(8)
        and want_odd_s134217728(8) != want_odd_s256(8)
        and want_odd_s134217728(8) != want_clip_gp(8)
...
def prefixes() -> dict:
    zp = json.loads(ZP_JSON.read_text())
    ...
    ok = (
        ...
        and zp["verdict"]["ph134217728_j134217728_partner_5U134217728"] == "LEMMA"
        ...
        and zp["verdict"]["packed_R_eq_ST"] == "PREFIX"
        and zp["verdict"]["prize"] == "unsolved"
        and want_d2_n(0) == 2
        and jacobsthal(2) == 1
    )
    return {"ok": ok}
...
def main() -> None:
    ...
    dump = {
        ...
        "odd_s134217728_fold": {k: cnt[k] for k in cnt if k != "ok"},
        ...
        "lemmas": {
            "odd_s134217728_eq_J_k_minus_22369621m1_plus_22369622_k_ge_28": True,
            "first_odd_s134217728_eq_ph67108865_k_ge_26": True,
            "packed_R_eq_ST": False,
            "E_all_k": False,
            "prize": False,
        },
        "verdict": {
            "odd_s134217728_eq_J_k_minus_22369621m1_plus_22369622_k_ge_28": "LEMMA",
            "first_odd_s134217728_eq_ph67108865_k_ge_26": "LEMMA",
            "odd_s134217728_eq_form_at_k27": "KILLED",
            "odd_s134217728_eq_form_at_k26": "KILLED",
            "odd_s134217728_eq_odd_s67108864_at_k26": "KILLED",
            "odd_s134217728_eq_odd_s33554432_at_k26": "KILLED",
            "odd_s134217728_eq_clip_gp_at_k26": "KILLED",
            "odd_s134217728_eq_odd_s67108864_at_k25": "KILLED",
            "odd_s134217728_eq_clip_gp_at_k25": "KILLED",
            "odd_s134217728_eq_clip_gp_at_k8": "KILLED",
            "odd_s134217728_eq_J_k_at_k8": "KILLED",
            "odd_s134217728_eq_odd_s512_at_k8": "KILLED",
            "ph67108865_covering_at_k25": "KILLED",
            "pal_c_eq_ST": "KILLED",
            "E_q10_10": "CERTIFIED",
    ...
    print("odd s134217728 k8", dump["odd_s134217728_fold"]["rows"]["8"])
