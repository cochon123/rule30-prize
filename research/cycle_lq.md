...
\(19\), hence odd, so the \(p=88\) \(0100\) XOR is \(1\). This is
**not** \(0100\) for all \(k\), **not** xor \(0\) for \(k\ge 6\),
...
Certify: `python3 research/cycle_lq.py --certify` (~0.22s).
...
Certified \(k\le 6\) (\(28\) events at \(k\ge 6\)). XOR is \(1\).
...
\(0100\) for all \(k\): \(k=4\), \(q=6\) is \(0010\). Xor \(0\) for
\(k\ge 6\): count \(9\), xor \(1\). Equal to the \(p=6\) count:
...
`KILLED` (\(0100\) for all \(k\); xor \(0\) for \(k\ge 6\); equal to
