...
Odd-n unpaired extra at j=2n-5U-1073741824 with j>=2 has count
J_k+178956971(-1)^k+178956970 for k>=31. The first cell is n=5U/2+536870913, j=2
for k>=29. Dies at k=30 for that formula (got 357913942, not 715827882). Dies
at k=29 for that formula (got 89478486, not 178956970). Dies at k=29 for
equals odd_s536870912 and odd_s268435456 and clip_gp (got 89478486, not
178956970). Dies at k=28 for covering. Do not kill equals
...
odd_s512 or odd_s128 or odd_s32 or odd_s8 or odd_s4 or odd_s536870912 at k=30 (all 357913942).
Do not kill pal_kind unpaired at n=5U/2+536870913, j=2 for k>=29. Do not
...
Run: python3 research/cycle_zz.py --certify
Dump: research/cycle_zz.json
"""
...
from cycle_zx import want_even_s536870912
from cycle_zy import ph1073741824_n
from period2_fiber import rule30_step

OUT = Path(__file__).resolve().with_suffix(".json")
ZY_JSON = Path(__file__).resolve().parent / "cycle_zy.json"
...
def ph536870913_n(k: int) -> int:
    """Covering n=5U/2+536870913, first odd partner-5U+1073741824 cell."""
    return parent_half(k) + 536870913


def want_odd_s1073741824(k: int) -> int:
    """Odd-n unpaired extra at partner 5U+1073741824, j>=2: 0 at k<=28, 89478486 at k=29, 357913942 at k=30."""
    if k <= 28:
        return 0
    if k == 29:
        return 89478486
    if k == 30:
        return 357913942
    return jacobsthal(k) + 178956971 * ((-1) ** k) + 178956970


def odd_s1073741824_split(k: int) -> dict:
    """Odd-n unpaired extra at j=2n-5U-1073741824 with j>=2. Do not call from tot_form."""
    u = 1 << k
    clip = 5 * u
    n_at = n_bad = 0
    first = None
    for n in range(1, 4 * u, 2):
        j = 2 * n - clip - 1073741824
...
def tot_form() -> dict:
    """k<=64: odd slice J_k+178956971(-1)^k+178956970 for k>=31; dies at k=30 for that form.

    Do not call odd_s1073741824_split here.
    Census is odd_s1073741824_fold for k<=8.
    """
    n_ok = 0
    if want_odd_s1073741824(0) != 0 or want_odd_s1073741824(28) != 0:
        return {"ok": False, "k026": True}
    if want_odd_s1073741824(29) != 89478486 or want_odd_s1073741824(30) != 357913942:
        return {"ok": False, "k2728": True}
    if want_odd_s1073741824(31) != 715827882 or want_odd_s1073741824(32) != 1789569706:
        return {"ok": False, "k2930": True}
    if want_odd_s1073741824(29) == want_odd_s1073741824(30):
    ...
    for k in range(0, K_ALG + 1):
        ...
        if k <= 28 and want_odd_s1073741824(k) != 0:
            return {"ok": False, "z": True, "k": k}
        if k == 29:
            if want_odd_s1073741824(k) != 89478486:
                return {"ok": False, "k27": True}
            if want_odd_s1073741824(k) == jacobsthal(k) + 178956971 * ((-1) ** k) + 178956970:
                return {"ok": False, "k27f": True}
        if k == 30:
            if want_odd_s1073741824(k) != 357913942:
                return {"ok": False, "k28": True}
            if want_odd_s1073741824(k) == jacobsthal(k) + 178956971 * ((-1) ** k) + 178956970:
                return {"ok": False, "k28f": True}
        if k >= 31 and want_odd_s1073741824(k) != jacobsthal(k) + 178956971 * ((-1) ** k) + 178956970:
    ...
    ok = (
        n_ok == K_ALG + 1
        and want_odd_s1073741824(29) != jacobsthal(29) + 178956971 * ((-1) ** 29) + 178956970
        and want_odd_s1073741824(30) != jacobsthal(30) + 178956971 * ((-1) ** 30) + 178956970
        and want_odd_s1073741824(8) != want_odd_s512(8)
        and want_odd_s1073741824(8) != want_odd_s256(8)
        and want_odd_s1073741824(8) != want_clip_gp(8)
        and want_odd_s1073741824(8) != jacobsthal(8)
        and want_odd_s1073741824(8) != want_even_s512(8)
        and want_odd_s1073741824(8) == want_odd_s134217728(8)
        and want_odd_s1073741824(8) == want_odd_s67108864(8)
        and want_odd_s1073741824(8) == want_odd_s33554432(8)
        and want_odd_s1073741824(8) == want_even_s134217728(8)
        and want_odd_s1073741824(8) == want_even_s67108864(8)
        and want_odd_s1073741824(8) == want_even_s33554432(8)
        and want_odd_s1073741824(27) == want_odd_s536870912(27)
        and want_odd_s1073741824(28) == want_odd_s536870912(27)
        and want_odd_s1073741824(28) != want_odd_s536870912(28)
        and want_odd_s1073741824(28) != want_odd_s268435456(28)
        and want_odd_s1073741824(28) != want_clip_gp(28)
        and want_odd_s1073741824(29) != want_odd_s536870912(29)
        and want_odd_s1073741824(29) != want_odd_s268435456(29)
        and want_odd_s1073741824(29) != want_clip_gp(29)
        and want_odd_s1073741824(29) == want_odd_s268435456(28)
        and want_odd_s1073741824(29) == want_odd_s134217728(28)
        and want_odd_s1073741824(29) == want_odd_s4(28)
        and want_odd_s1073741824(30) == want_odd_s134217728(30)
        and want_odd_s1073741824(30) == want_odd_s33554432(30)
        and want_odd_s1073741824(30) == want_odd_s8388608(30)
        and want_odd_s1073741824(30) == want_odd_s2097152(30)
        and want_odd_s1073741824(30) == want_odd_s524288(30)
        and want_odd_s1073741824(30) == want_odd_s131072(30)
        and want_odd_s1073741824(30) == want_odd_s32768(30)
        and want_odd_s1073741824(30) == want_odd_s8192(30)
        and want_odd_s1073741824(30) == want_odd_s2048(30)
        and want_odd_s1073741824(30) == want_odd_s512(30)
        and want_odd_s1073741824(30) == want_odd_s128(30)
        and want_odd_s1073741824(30) == want_odd_s32(30)
        and want_odd_s1073741824(30) == want_odd_s8(30)
        and want_odd_s1073741824(30) == want_odd_s4(30)
        and want_odd_s1073741824(30) == want_odd_s536870912(30)
        and want_odd_s1073741824(30) != want_clip_gp(30)
        and want_odd_s1073741824(30) != want_odd_s268435456(30)
        and want_odd_s1073741824(30) != want_even_s536870912(30)
        and want_odd_s1073741824(30) != want_even_s268435456(30)
        and want_odd_s1073741824(8) == 0
        and want_odd_s1073741824(28) == 0
        and want_odd_s1073741824(29) == 89478486
        and want_odd_s1073741824(30) == 357913942
        and want_odd_s1073741824(31) == 715827882
        and jacobsthal(29) + 178956971 * ((-1) ** 29) + 178956970 == 178956970
        and jacobsthal(30) + 178956971 * ((-1) ** 30) + 178956970 == 715827882
        and jacobsthal(31) + 178956971 * ((-1) ** 31) + 178956970 == 715827882
        ...
        and ph536870913_n(8) == 536871553
        and ph536870913_n(28) == 1207959553
        and ph536870913_n(29) == 1879048193
        and ph536870913_n(30) == 3221225473
        and ph1073741824_n(8) == 1073742464
        ...
        and pal_kind(ph536870913_n(26), 2, 26) == "unp"
        and pal_kind(ph536870913_n(29), 2, 29) == "unp"
        and pal_kind(ph536870913_n(28), 2, 28) == "unp"
        and pal_kind(ph536870913_n(29), 2, 29) == "unp"
        and pal_kind(ph536870913_n(29), 2, 29) != "pair"
        and G(ph536870913_n(28), 2) == 1
        and G(ph536870913_n(29), 2) == 1
        and ph536870913_n(28) >= 4 * (1 << 28)
...
def odd_s1073741824_fold() -> dict:
    """k<=8 odd partner-5U+1073741824 slice vs J_k+178956971(-1)^k+178956970 for k>=31."""
    n_ok = 0
    rows = {}
    for k in range(0, K_COUNT + 1):
        a = odd_s1073741824_split(k)
        if a["n_bad"] != 0:
            return {"ok": False, "bad": True, "k": k, "got": a}
        if a["n_at"] != want_odd_s1073741824(k):
            return {"ok": False, "at": True, "k": k, "got": a["n_at"]}
        if k >= 29:
            if a["first"] != (ph536870913_n(k), 2):
                return {"ok": False, "first": True, "k": k, "got": a["first"]}
        if k <= 28 and a["first"] is not None:
...
def killed_eq() -> dict:
    """formula at k=29 and k=30; equals odd_s536870912 at k=29; covering at k=28."""
    ok = (
        want_odd_s1073741824(29) != jacobsthal(29) + 178956971 * ((-1) ** 29) + 178956970
        and want_odd_s1073741824(30) != jacobsthal(30) + 178956971 * ((-1) ** 30) + 178956970
        and want_odd_s1073741824(8) != want_odd_s512(8)
        and want_odd_s1073741824(8) != want_odd_s256(8)
        and want_odd_s1073741824(8) != want_clip_gp(8)
...
def prefixes() -> dict:
    zy = json.loads(ZY_JSON.read_text())
    zt = json.loads(ZT_JSON.read_text())
    zw = json.loads(ZW_JSON.read_text())
    ok = (
        zy["checks"]["all_ok"]
        and zt["checks"]["all_ok"]
        and zw["checks"]["all_ok"]
        and zy["verdict"]["ph1073741824_eq_2fold_zv_k_ge_2"] == "LEMMA"
        ...
        and zy["verdict"]["packed_R_eq_ST"] == "PREFIX"
        and zy["verdict"]["prize"] == "unsolved"
        and want_d2_n(0) == 2
        and jacobsthal(2) == 1
    )
    return {"ok": ok}
...
def main() -> None:
    ...
    dump = {
        ...
        "odd_s1073741824_fold": {k: cnt[k] for k in cnt if k != "ok"},
        ...
        "lemmas": {
            "odd_s1073741824_eq_J_k_plus_178956971m1_plus_178956970_k_ge_31": True,
            "first_odd_s1073741824_eq_ph536870913_k_ge_29": True,
            "packed_R_eq_ST": False,
            "E_all_k": False,
            "prize": False,
        },
        "verdict": {
            "odd_s1073741824_eq_J_k_plus_178956971m1_plus_178956970_k_ge_31": "LEMMA",
            "first_odd_s1073741824_eq_ph536870913_k_ge_29": "LEMMA",
            "odd_s1073741824_eq_form_at_k30": "KILLED",
            "odd_s1073741824_eq_form_at_k29": "KILLED",
            "odd_s1073741824_eq_odd_s536870912_at_k29": "KILLED",
            "odd_s1073741824_eq_odd_s268435456_at_k29": "KILLED",
            "odd_s1073741824_eq_clip_gp_at_k29": "KILLED",
            "odd_s1073741824_eq_odd_s536870912_at_k28": "KILLED",
            "odd_s1073741824_eq_clip_gp_at_k28": "KILLED",
            "odd_s1073741824_eq_clip_gp_at_k8": "KILLED",
            "odd_s1073741824_eq_J_k_at_k8": "KILLED",
            "odd_s1073741824_eq_odd_s512_at_k8": "KILLED",
            "ph536870913_covering_at_k28": "KILLED",
            "pal_c_eq_ST": "KILLED",
            "E_q10_10": "CERTIFIED",
    ...
    print("odd s1073741824 k8", dump["odd_s1073741824_fold"]["rows"]["8"])
